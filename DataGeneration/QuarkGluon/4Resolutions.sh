...
python3 ToPointCloud.py --input_file=input.h5 --output_file=${BASE_DIR}/Dataset/QG1024.h5 --num_points=1024 &
python3 ToPointCloud.py --input_file=input.h5 --output_file=${BASE_DIR}/Dataset/QG768.h5 --num_points=768 &
python3 ToPointCloud.py --input_file=input.h5 --output_file=${BASE_DIR}/Dataset/QG512.h5 --num_points=512 &
python3 ToPointCloud.py --input_file=input.h5 --output_file=${BASE_DIR}/Dataset/QG256.h5 --num_points=256 &
